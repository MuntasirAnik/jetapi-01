...
export default function LoginPage() {
  ...
  return (
    <div className="w-full h-full bg-[var(--background)] flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-[1000px] h-[600px] mx-4 bg-[var(--card)]/60 backdrop-blur-2xl border border-[var(--border)] rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] flex overflow-hidden z-10 animate-in zoom-in-95 duration-500 relative">
