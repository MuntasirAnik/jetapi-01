  ...
  return (
    <div className="w-full h-full bg-[var(--background)] flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-[1000px] h-[640px] mx-4 bg-[var(--card)]/60 backdrop-blur-2xl border border-[var(--border)] rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] flex overflow-hidden z-10 anim-scale-in relative">
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center items-center bg-[var(--background)]/40 relative">
          
          <div className="w-full max-w-[360px]">
            <div className="mb-8 text-center">
              <h3 className="text-2xl font-bold text-[var(--foreground)] tracking-tight mb-2">Create Account</h3>
              <p className="text-[var(--muted)] text-sm">Sign up to start building your first workspace.</p>
            </div>
            ...
            <div className="flex flex-col gap-3 w-full mb-5">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-[#24292f] hover:bg-[#30363d] text-white font-semibold px-4 py-3 rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 shadow-md hover:shadow-lg"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-[var(--sidebar)] hover:bg-[var(--card)] border border-[var(--border)] text-[var(--foreground)] font-semibold px-4 py-3 rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 shadow-md hover:shadow-lg"
              >
            ...
            <div className="group">
              <label className="text-xs font-bold uppercase tracking-wider text-[var(--muted)] mb-1.5 block group-focus-within:text-[var(--color-brand-500)] transition-colors">Full Name</label>
              <input 
                type="text" 
                value={name} 
            ...
            <div className="group">
              <label className="text-xs font-bold uppercase tracking-wider text-[var(--muted)] mb-1.5 block group-focus-within:text-[var(--color-brand-500)] transition-colors">Password</label>
