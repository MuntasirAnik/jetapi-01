...
import { Search, X, ShieldCheck, User as UserIcon, Loader2, Trash2, Crown, ChevronDown, Shield, Edit3 } from "lucide-react";
  ...
  const fetchData = async (showLoadingState = true) => {
    ...
    try {
      ...
      if (colRes.ok) {
        ...
        // The backend now returns { collection, membership } from findOne
